...
Poloha: OBRAZEKOBRAZEK $y=y_m*sin(\alpha), přejmenujeme r\rightarrow y_m, \alpha = \omega t \Rightarrow y=y_m*sin(\omega t), popř. y=y_m*sin(\omega t+{\phi}_0), {\phi}_0 -- počáteční fáze (případný offset na začátku od nul. úhlu)$
