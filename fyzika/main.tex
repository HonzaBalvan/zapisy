...
Původní vzorec pro kinetickou energii nebyl úplně nepravdivý, je to jenom zanedbání miniaturních členů v této rovnici pro $v << c$ (má to smysl asi do $1\% c$)

Př.: Urychlíme elektron napětím $1000V$, jakou bude mít rychlost:
\begin{enumerate}[a.]
  \item klasickým vzorcem: $UQ = \frac{1}{2}mv^2 \implies v = \sqrt{\frac{2Ue}{m}} \approxeq 0,0625 c = 1,8752 \cdot 10^7 m/s$
  \item spec. teor. rel.: $UQ = m_0 c^2 (\gamma - 1), \gamma = \frac{1}{\sqrt{1-\Beta^2}} \implies v = \sqrt{\frac{(\frac{Ue}{m_0 c^2}+1)^2-1}{(\frac{Ue}{m_0 c^2}+1)^2}} \cdot c \approxeq 1,8725 \cdot 10^7 m/s$ 
\end{enumerate}
$\implies$ výsledky stejné na tři platné číslice -- klasický vzorec není naprosto správně, ale je mnohem rychlejší a pro menší rychlosti je naprosto dostatečný

Vraťme se k $E_0 = m_0 c^2$ -- klidová energie 
-- co to ale znamená? $c^2$ jako universální konstanta je jen nějaké číslo, závisející na jednotkové soustavě
-- hmotnost a energie jsou tedy ekvivalentní, v dobře zvoleném systému jednotek se rovnají 
-- to mi umožňuje počítat hmotnost v Joulech a energii v kilogramech
$\implies$ hmotnost elektronu: $9,1 \cdot 10^{-31} kg \iff E = mc^2 = 8,19 \cdot 10^{-14} J = 0,511 MeV$
