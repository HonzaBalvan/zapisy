...
\section{Ruchovci a lumírovci}
\begin{itemize}
  \item obě dvě skupiny patetické, sentimentální, novoromantické
\end{itemize}
...
\begin{itemize}
  ...
  \item umění pro umění (parnasismus -- Parnas, kde sídlí múzy) -- nesmírně důležitá forma AAAAAAA
  \item překládali, snažili si převést i formu jazyka
  \item na přelomu 70/80 se skupiny čím dál víc dostávaly do sporů
\end{itemize}
