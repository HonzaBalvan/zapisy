...
\begin{itemize}
  \item surrealismus -- nadrealismus
  \item Guillaume Apollinaire
  \item kromě toho co je ovlivňováno rozumem je i něco nad tím, něco co člověk rozumem nepojme a nevysvětlí a co se dá objevit tehdy když člověk rozum odbourá -- pomocí omamných látek, meditace, silných emocí, spánku - snění, hypnózy -- surrealisté chtěli zkoumat lidské podvědomí
  \item tvůrci ze začátku experimentovali se vším výše uvedeným, zážitky a obrazy z těchto stavů se snažili různými způsoby zapisovat, postupně se do toho dostali, už se nemuseli vypínat aby to bylo surrealní
  \item malíři Salvador Dalí, Louis Aragon, filmový režisér Luis Buñuel
  \item v literatuře se projevuje: užívání metod uvedených výše, volné sledy myšlenek, těžko dešifrovatelné pro čtenáře
  \item toto samozřejmě nefungovalo např. u románu
\end{itemize}

\section{Ostatní}
\begin{itemize}
  \item civilismus -- oslava techniky a všeho co usnadňuje život
  \item vitalismus -- oslava zdravého životního stylu, života, radosti ze života, životní energie
  \item naturismus -- oslava přírody
  \item unanimismus -- víra ve spojení lidských duší v jednu, ve smyslu toho, že když se opakovaně schází lidé tak se začnou navzájem ovlivňovat tak, že vzniká nějaký duch (pro ně duše) kolektivu
  \item pragmatismus -- myšlení a poznání by mělo sloužit praktickému užitku, důležité je tedy to, co je prospěšné, v literatuře to, co je pro jednotlivce cestou k cíli nemusí být pro jiného člověka cestou k cíli, nelze si myslet, že existuje jediná správná cesta, neexistuje jediná pravda, u nás se tím hodně zabýval Karel Čapek
  \item marxismus -- levicový směr, který se původně zabýval ekonomií, Marx zdůrazňuje množství neduhů kapitalistické ekonomiky, v literatuře se píše o vrstvách dle Marxových teorií a jak si žijí, jaké jsou mezi nimi rozdíly
  \item secese -- umění, které se snaží reagovat nějakým protikladem k pře-- modernímu světu, který je orientován na výrobní produkci, protipol se má konat nějakým zdůrazněním přírody, důležitosti přírody pro človka a to i v městském prostředím, projevuje se to v architektuře ale i v užitkových předmětech, měla se promítat -- floralní motivy, např. Alfons Mucha, v literatuře propojeno s naturismem
  \item akméismus -- proti alternativním proudům, alternativa neoklasicismu v Rusku, stylová čistota, přesné vyjadřování, jasná komposice, zdůrazňování intelektu na úkor citu
  \item dadaismus -- Tristan Tzara -- směr který absolutizuje náhodu -- tzn. ti, kdo tvoří v duchu dadaismu říkají, že náýhodné prvky hrají důležitou roli aby vzniklo umělecké dílo dále říkají že dalším základním kamenem uměleckého díla je hravost určité spojování zdánlivě nespojitelného, tento směr vznikl jako reakce na wwi, Tzara prý když měl v hlavě myšlenku dadaismu tak si řekl potřebuju pro to najít název, takže si vzal encyklopedii, tu otevřel na náhodné stránce, a náhodně vybral slovo -- dada, což je ta koňská hlava na tyčce se kterou hraješ koně, tvořil tak že si rozstříhal noviny, pak náhodně vybral pár slov a znich skládal větu
\end{itemize}

\section{Autoři}
\begin{itemize}
  \item Christian Morgenstern (1871-1914) -- Vídeňák, předchůdce dadaismu a surrealismu, autor, který tvořil tzv. nonsensovou poezii, jeho sbírka Šibeniční písně
\end{itemize}
