...
\begin{flalign*}
  S &= \sqrt{s(s-a)(s-b)(s-c)}\text{, } s = \frac{a+b+c}{2}\\
  S &= \sqrt{21\cdot8\cdot7\cdot6} = 84\text{ cm}^2
\end{flalign*}\begin{flalign*}
  v_a &= \frac{2S}{a} = \frac{168}{14}\\
  v_b &= \frac{2S}{b} = \frac{168}{15}\text{ -- nejmenší}\\
  v_c &= \frac{2S}{c} = \frac{168}{13}
\end{flalign*}\begin{flalign*}
  k &= \frac{v_b - |\textbf{v}|}{v_b} = \frac{153}{168}\\
