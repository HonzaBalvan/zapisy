...
\begin{itemize}
  ...
  \begin{figure}[h]
      ...
      \caption{}
  \end{figure}
  \item celulosa jsou dvě cyklické $\beta$-D-glukosy spojené 1,4 vazbou -- tzv. $\beta$-D-glukan (jsou tu jen glukosy, takže to takhle můžu nazvat)
  ...
  \item zásobní polysacharidy -- rostlinné škroby, především pětina amylosy a čtyři pětiny amylopektinu -- obě dvě vybudovány z maltosových jednotek, škroby štěpeny $\alpha$-amylasou (sliny) a pankreatickou $\alpha$-amylasou (tenké střevo (pankreas)) a $\alpha$-glukosidasa, $\alpha$-dextrinasy a sacharasy (u malých dětí laktosa) (tlusté střevo)
  ...
  \item záobní látka ve svalech a játrech glykogen
\end{itemize}
\end{document}
