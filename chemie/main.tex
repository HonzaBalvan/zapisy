...
oxidace: $2Cr^{III}\rightarrow^{6e}2Cr^{VI}$ - - křížové pravidlo 2 -> 1
redukce: $N^{V}\rightarrow^{2e}N^{III}$ - - křížové pravidlo 6 -> 3
$\textit{1}Cr_2O_3 + \textit{3}KNO_3 + 4KOH \rightarrow 2K_3CrO_4 + 3KNO_2 + 2H_2O$

\subsubsection{V iontové formě}
$IO_3^{-}+Cl_2 + OH^{-} -> IO_6^{5-} + Cl^{-}+ H_2O$

\subsubsection{Disproporcionační rovnice}
$MnO_4^{2-}+ H_3O^{+} -> MnO_4^{-} + MnO_2 + H_2O$
$H_2S + SO_2 -> S + H_2O$
...
Látkové množství něčeho v něčem (něčeho v roztoku)
\[
