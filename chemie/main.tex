...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item začínáme nasycenými uhlovodíky
    \begin{itemize}
      \item musíme najít tzv. základní hybrid - nejdelší řetězec, nejvíce násobných vazeb a nejvíce substituentů a pojmenuju ho podle počtu uhlíků (níže) s příponou -an
      ...
      \item pak to spojuju pomlčkama, substituenty seřazuju podle abecedy, mezi posledním substituentem a názvem základního hydridu pomlčka není, takže např. 4-ethyl-3-methylhexan
      \item když mám někde cyklickou část, tak je to vždy základní hydrid, před její název dám cyklo-, číslování takové, aby součet čísel lokantů se substituenty byl co nejmenší (ekvivalentní s pravidlem pro necyklické uhlovodíky), takže např. 4-ethyl-1,1,2-trimethylcyklohexan
