...
\begin{itemize}
  ...
  \begin{itemize}
    \item samozřejmě v renesanci, 15. st., klesá vliv církve, klesá vliv jedince
    ...
    \item \textbf{Hus} - volnost víry
    \item \textbf{Chelčický} - pacifista
    \item \textbf{Jiří z Poděbrad} - idea evropské jednoty
    \item \textbf{Komenský} - domníval se, že když budou vládnout vzdělanci tak nebudou války, že by měl být jeden světový jazyk
    \item \textbf{Bolzano} - dílo O nejlepším státě (další utopie)
    \item \textbf{Palacký} - prosazoval ideu austroslavismu - aby vznikla na habsburském území federace rovnocenných národů
    \item \textbf{Masaryk} -
    \item \textbf{Beneš} (jak taky jinak) - 
  \end{itemize}
\end{itemize}
