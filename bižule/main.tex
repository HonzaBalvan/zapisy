...
\section{třída Ptáci}
\begin{itemize}
  \item vývojová větev plazů, nejblíž jim historicky dinosauři
  \item první archaeopterix
  \item jsou teplokrevní (endodermové), jejich tělesná teplota je asi 40 °C
  ...
  \item 2 teorie vzniku létání -- lezeme po stromech a plachtíme x mávám prstíkama a dojde mi, že můžu lítat
  ...
  \item peří krycí (např. prachové, kryje), letky (na křídlech, aerodynamika) a rejdovací (na ocase, kormidlo), peří se skládá z ostnu a praporu (ten pak z větví, paprsků a háčků) OBRAZEKOBRAZEK
  \item pneumatizované kosti -- duté, kosti bývají často srostlé (např. u končetin, na páteři), aby kostra byla pevnější, nepotřebují být ohební, mají velikánskou hrudní kost na kterou se uchycují letácí prsní svaly -- hrudní hřeben
  \item anisodaktylní noha -- tři prsty dopředu, jeden dozadu, zyodaktylní noha -- jednen prst převrácen dozadu, noha šplhavá, syndaktylní noha -- srostlé prsty
  \item pro létání tedy prsní (stlačení křídel) a podkrkavčí (roztahování) sval
  \item tibiotarsus - postavení šlach, které ptákům umožňuje zaklesnout drápy tak, aby se udrželi např. na větvi bez vynakládání energie (můžou u toho např. spát)
  \item trávicí soustava odlehčená -- zkrácená střeva, mají vole (zde si můžou uchovat část potravy nebo tvořit kaši, slouží ke krmení mláďat)
  \item mají plíce, mají vzdušné vaky -- bálonek, kam si ukládá rezervní vzduch
