...
\item intervaly s krajními body (a, b) = {x \in \mathbb R; a < x < b}, resp. ..., resp. neomezené pozor hranaté závorky! a ne zobáčky

Definice. (Absolutní hodnota) Nechť x \in \mathbb R. Potom x \def \begin{cases}{x, x \geq 0 \\ -x, x < 0}
