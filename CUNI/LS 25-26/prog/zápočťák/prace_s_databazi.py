...
def ulozDatabazi(args, databaze):
    ...
    with open(args.soubor, encoding="utf-8") as soubor:
        ...
        for radek_souboru in soubor_radky:
    ...
    with open(args.soubor, "w", encoding="utf-8") as soubor:
        soubor.write("")

    with open(args.soubor, "a", encoding="utf-8") as soubor:
        for radek in vystup:
