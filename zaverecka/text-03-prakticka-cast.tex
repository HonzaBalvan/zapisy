...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\linewidth]{zihana_skalice.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\linewidth]{zlaty_dest.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\linewidth]{chromatografie.png}
