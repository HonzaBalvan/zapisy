...
\section{Metodika}
Z dostupných zdrojů je nejdřívě zjištěna podstatu pokusu a~postup jeho provedení. Pokus je proveden, přičemž je dokumentován (fotoaparátem či kamerou) každý krok za účelem možného doplnění nebo opravení nedostatků v~původním zdroji. V~případě potřeby je pokus zopakován. Zároveň jsou poznamenány všechny bezpečnostní požadavky, které jsou potřeba pro provedení pokusů.
